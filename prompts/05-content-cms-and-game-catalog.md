# DRAGON-05 — Content CMS and game catalog
...
Mission:
Implement bilingual content publishing and the game catalog as complete public/admin vertical slices.
...
Acceptance criteria:
- Implement content types required for news, articles, announcements, guides, rules, and informational pages with draft/review/publish/archive scheduling and version history.
- Implement games, localized metadata, media, slugs, SEO fields, tournament relationships, and admin CRUD with validation and audit.
- Implement public home, listing, detail, category/tag/game pages, filtering, pagination, canonical/localized routes, and actual 404 responses.
- Sanitize rich content and validate media references; drafts and restricted versions must never leak publicly.
- Add bilingual API, component, browser, SEO, authorization, and publication-state tests.
