# DRAGON-16 slice — Security hardening

Parent prompt: `16-accessibility-performance-and-security-hardening.md`

## Mission
Complete threat-model-driven authorization, input, session, secret, header, audit, and abuse-control hardening with security tests.
