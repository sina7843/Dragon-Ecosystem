# DRAGON-11 slice — Ledger core and invariants

Parent prompt: `11-mock-payment-and-dragon-coin-ledger.md`

## Mission
Implement immutable balanced ledger entries, idempotency keys, transaction boundaries, indexes, and reconciliation primitives.
