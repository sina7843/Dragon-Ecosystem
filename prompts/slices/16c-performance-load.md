# DRAGON-16 slice — Performance and load

Parent prompt: `16-accessibility-performance-and-security-hardening.md`

## Mission
Measure and optimize critical paths, indexes, bundle/runtime behavior, and tournament operations up to the approved 1,000-participant limit.
