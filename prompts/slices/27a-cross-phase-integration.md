# DRAGON-27 slice — Cross-phase integration audit

Parent prompt: `27-whole-ecosystem-final-audit-and-release-evidence.md`

## Mission
Verify identity, authorization, event, entitlement, localization, and navigation contracts across all enabled phases.
