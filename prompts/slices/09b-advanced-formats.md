# DRAGON-09 slice — Advanced competition formats

Parent prompt: `09-competition-engine-and-standings.md`

## Mission
Implement double-elimination, Swiss, and manual/custom format behavior without changing the approved invariants; add format-specific fixtures and test IDs.
