# DRAGON-19 — Phase 2 live chat, moderation, and release
...
Mission:
Implement moderated live chat and close Phase 2 acceptance without weakening shared identity or moderation boundaries.
...
Open decisions:
- OD-013 [release-blocker]: Block Phase 2 release.
- OD-014 [release-blocker]: Block Phase 2 release.
...
Acceptance criteria:
- Implement room membership/access, ordered messages, duplicate protection, rate limits, timeout/ban, report evidence, moderator actions, and observable delivery.
- Integrate chat moderation into shared moderation cases and audit while preserving removed-message evidence.
- Test backpressure, reconnect, duplicate delivery, timeout, bans, privacy, abuse, and bilingual responsive stream/chat journeys.
- Complete Phase 2 traceability and provider-stub tests; keep contracted Arvan-only checks explicitly blocked until credentials/capabilities exist.
- Produce a Phase 2 go/no-go verdict with external blockers separated from implementation failures.
