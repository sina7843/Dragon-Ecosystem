/**
 * Builds the machine-readable site inventory of the running product.
 *
 ...
 *
 * Usage: node scripts/extract-inventory.mjs [--out <path>]
 */
...
const inventory = {
  generatedFrom: {
    note: 'Extracted from source by scripts/extract-inventory.mjs. Do not hand-edit.',
...
const out = outIndex === -1 ? join(ROOT, 'docs', 'SITE_INVENTORY.json') : process.argv[outIndex + 1];
