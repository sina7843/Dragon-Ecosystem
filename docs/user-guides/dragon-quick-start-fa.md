<!--
Quick-start source. Shorter operational reference; the complete manual is the authority.
Generated tables come from the same markers as the complete guide.
-->
